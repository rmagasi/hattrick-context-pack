...
Terminology mappings for Hattrick managers playing the game in Hungarian. HRF files, Foxtrick UI, and forum posts in Hungarian use these terms - use this reference when interpreting them or translating between Hungarian and English Hattrick vocabulary.
...
| edzes | Training |
| edzo | Coach |
| asszisztens edzo | Assistant Coach |
| orvos | Doctor / Medic |
| sportpszichologus | Sports Psychologist |
| formaedzo | Form Coach |
| penzugyi igazgato | Financial Director |
| taktikai asszisztens | Tactical Assistant |
| ifi / ificsapat | Youth / Youth Academy |
| nevelőegyesület | Motherclub (own youth pull) |
| atigazolas | Transfer |
| ugynok / ugynoki dij | Agent / agent fee |
| ela tulajdonosnak jaro dij | Previous-owner fee |
| jatekosmegfigyelo | Scout |
| jatekosmegfigyeloi rendszer | Scout Network (a.k.a. "lottos") |
| eFt | ezer Forint = 1,000 HUF |
| szezon | Season |
| szabalyzat | Rulebook |
| szurkolo | Supporter / fan |
| szponzor | Sponsor |
| arena / stadion | Arena / Stadium |
| kapus | Goalkeeper (GK) |
| vedo | Defender (CD / WB) |
| kozeppalyas | Midfielder (IM) |
| szelso | Wing(er) (W) |
| tamado | Forward (FW) |
| bajnoksag / bajnoki | League / league match |
| kupa | Cup |
| bajnokavato / bajnoki cim | Title |
| feljutas | Promotion |
| kiesés | Relegation |
| osztaly | Division |
| csoport | Group |
...
| atlag | Average |
| osszesen | Total |
| mérkőzésidőpontok | Match times |
| helyi menetrend | Local schedule |
| napi frissites | Daily update |
| heti frissites | Weekly update |
| serult | Injured |
| szakorvosi velemeny | Doctor's opinion / injury status |
| forma | Form |
| tapasztalat | Experience |
| husegjutalom / huseg | Loyalty / loyalty bonus |
| egyeniseg | Personality / specialty |
| specialitas | Specialty |
| gyors | Quick (specialty) |
| muszaki / technikas | Technical |
| fejjatekos / fejes | Head |
| erős / erőszakos | Powerful |
| kiszamithatatlan | Unpredictable |
| segito | Support |
| ellenallo | Resilient |

## Cup names in Hungary

- National Cup: **Magyar Kupa**
- League Cups (round-1 / round-2 / round-3 losers respectively): **Puskas Ferenc / Smaragd** → **Bozsik Jozsef / Rubin** → **Hidegkuti Nandor / Zafir**
- Consolation Cup: **Vigaszag**
...
To add another language pack (German, Spanish, Swedish, Polish, etc.), follow this file's structure:

1. Create `references/languages/<language>.md`
2. Include the same sections: skill levels, mood scales, team/player attributes, common terms, country-specific cup names, currency notation
3. Source from Appendix 2 of the rulebook in the target language
4. Submit a PR
